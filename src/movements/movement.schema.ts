...
export class Movement {
  ...
  dueAt: Date | null; // issue only: expected return time. "overdue" = now > dueAt and not yet returned (derived)
  ...
  closesMovementId: Types.ObjectId | null;
  ...
  corrects: Types.ObjectId | null; // which movement this corrects
  ...
  note: string | null; // human-readable reason (refusal, damage, correction)

  @Prop({ type: String, default: null })
  recordedBy: string | null; // store keeper name (picked from a list, no auth)
